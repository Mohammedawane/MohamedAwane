  ...
  return (
    <section className="relative flex min-h-screen items-center justify-center overflow-hidden px-6 pb-16 pt-24 bg-gradient-to-br from-blue-900 via-blue-800 to-blue-700">
      ...
      <div className="relative mx-auto max-w-5xl text-center">
        ...
        {/* Badge */}
        <div
          className="animate-fade-up mb-8 inline-flex items-center gap-2.5 rounded-2xl border border-white/20 bg-white/10 px-5 py-2 text-sm text-blue-100 backdrop-blur-sm"
