...
import "./globals.css";
import FacebookPixel from "@/app/Component/FacebookPixel";
    ...
    >
      <body className="min-h-full flex flex-col">
        ...
        <a
          ...
          aria-label="WhatsApp"
          className="fixed bottom-6 right-6 z-50 flex h-14 w-14 items-center justify-center rounded-full shadow-lg shadow-green-600/30 transition-transform duration-300 hover:scale-110"
